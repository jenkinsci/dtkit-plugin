...
public class DTKitBuilder extends Builder {
	...
	private void constructTUSARReportPathForSonar(final AbstractBuild<?, ?> build, String reportPaths){
        ...
        StringParameterValue parameter = (StringParameterValue) a.getParameter("sonar.tusar.reportsPaths");
        // If there is more than one dtkit build step, we have to update the
        // sonar.tusar.reportsPaths property
        if (null != parameter) {
            build.removeAction(a);
            List<ParameterValue> parameterValues = new ArrayList<ParameterValue>();
            parameterValues.add(new StringParameterValue("sonar.language", "tusar"));
            parameterValues.add(new StringParameterValue("sonar.tusar.reportsPaths", parameter.getValue() + ";" + reportPaths));
